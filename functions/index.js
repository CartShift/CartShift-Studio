...
const ANALYSIS_TEXTS = {
  en: {
    ...
    greeting: 'Hello,',
    introText:
      "We've completed an evidence-based analysis of your e-commerce store. This report separates measured lab results, verified findings, estimates, and areas that need a deeper scan.",
    ...
    priorityFixesTitle: 'Next Priority Improvements',
    priorityFixesSubtitle: 'Up to three unique root-cause actions from the evidence collected',
    ...
    ctaTitle: 'Review the Findings With an Expert',
    ctaText:
    ...
    criticalIssuesLabel: 'Priority Areas',
    ...
    taskSingular: 'task',
    taskPlural: 'tasks',
    noCriticalIssuesFound: 'No priority action areas were identified from this scan.',
    noPriorityActionsFound: 'No priority action areas were identified from this scan.',
    ...
    scoreStatus: {
      ...
      warning: 'Needs work. Several measured or verified improvements are available.',
      critical: 'Critical score range. Review measured and verified findings before acting.',
    },
    confidence: {
      measured: 'Measured lab result',
      verified: 'Verified',
      estimated: 'Estimated',
      insufficient_evidence: 'Needs deeper scan',
    ...
    deeperScanTitle: 'Deeper Scan Evidence',
    deeperScanSubtitle:
      'Category, product, and cart interaction samples used to qualify checkout recommendations',
    deeperScanCategoryPages: 'Category pages',
    deeperScanProductPages: 'Product pages',
    deeperScanCartInteraction: 'Cart interaction',
    deeperScanSucceeded: '{count} succeeded',
    deeperScanAttempted: '{count} attempted',
    deeperScanAvailable: 'Available',
    deeperScanNotVerified: 'Not verified',
    deeperScanUnavailableTitle: 'Deeper scan unavailable',
    deeperScanUnavailableText:
    ...
    deeperScanEvidence: 'Evidence',
    labMeasurementLimitation:
  ...
  he: {
    ...
    greeting: 'שלום,',
    introText:
      'סיימנו ניתוח מבוסס ראיות של חנות האיקומרס שלך. הדוח מפריד בין מדידות מעבדה, ממצאים מאומתים, הערכות ואזורים שדורשים סריקה עמוקה יותר.',
    ...
    priorityFixesTitle: 'השיפורים הבאים בעדיפות',
    priorityFixesSubtitle: 'עד שלוש פעולות ייחודיות לפי שורש הבעיה והראיות שנאספו',
    ...
    ctaTitle: 'סקירת הממצאים עם מומחה',
    ctaText:
    ...
    criticalIssuesLabel: 'אזורי עדיפות',
    ...
    taskSingular: 'משימה',
    taskPlural: 'משימות',
    noCriticalIssuesFound: 'לא זוהו אזורי פעולה בעדיפות לפי הסריקה הזו.',
    noPriorityActionsFound: 'לא זוהו אזורי פעולה בעדיפות לפי הסריקה הזו.',
    ...
    scoreStatus: {
      ...
      warning: 'דורש שיפור. קיימים כמה שיפורים מדידים או מאומתים.',
      critical: 'טווח ציון קריטי. מומלץ לבדוק את הממצאים המדידים והמאומתים לפני פעולה.',
    },
    confidence: {
      measured: 'מדידת מעבדה',
      verified: 'מאומת',
      estimated: 'הערכה',
      insufficient_evidence: 'דורש סריקה עמוקה',
      unavailable: 'לא זמין',
    },
    sources: {
      lighthouse: 'Lighthouse',
      rendered_browser: 'דפדפן מרונדר',
      static_html: 'HTML סטטי',
      product_sample: 'דגימת מוצר',
      heuristic: 'כלל הערכה',
    },
    sections: {
      performance: 'ביצועים',
    ...
    deeperScanUnavailableText:
      'דגימת קטגוריות, מוצרים ואינטראקציית עגלה בדפדפן לא הייתה זמינה בהרצה הזו, ולכן המלצות צ׳קאאוט נשארות מבוססות על ראיות ברמת ביטחון נמוכה יותר.',
    deeperScanEvidence: 'ראיות',
    labMeasurementLimitation:
      'מדידת מעבדה. התוצאות עשויות להשתנות לפי הרצה, פרופיל מכשיר, רשת ומצב cache.',
    lcpLabel: 'Largest Contentful Paint (LCP)',
