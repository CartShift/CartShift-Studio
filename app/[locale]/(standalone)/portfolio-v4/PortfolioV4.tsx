      ...
      <ProjectLink project={project} locale={locale}>
        <div className="grid lg:grid-cols-[1.18fr_.82fr]">
          ...
          <div className="flex flex-col p-7 sm:p-10 lg:p-12">
            ...
            <h3 className="mt-10 whitespace-nowrap text-[clamp(3.2rem,13vw,5.8rem)] font-medium leading-[.84] tracking-[-.07em] text-[#1c1b20]" dir="ltr">StarLinker</h3>
      ...
      <ProjectLink project={project} locale={locale}>
        <div className="grid min-h-[43rem] lg:grid-cols-[.42fr_1fr]">
          <div className="flex flex-col border-white/12 p-7 sm:p-10 lg:border-e lg:p-12">
            ...
            <h3 className="mt-14 whitespace-nowrap text-[clamp(3.2rem,12.5vw,5.4rem)] font-medium leading-[.84] tracking-[-.07em] text-white" dir="ltr">RightFlow</h3>
        ...
        <div className="relative min-h-[47rem] p-7 sm:p-10 lg:p-14">
          ...
          <div className="relative flex h-full min-h-[40rem] flex-col">
            ...
            <div className="my-auto py-16">
              <p className="text-balance text-[clamp(2.4rem,9vw,4.4rem)] font-medium leading-[.88] tracking-[-.06em] text-[#c7afff]">{isHebrew ? 'ריליס הוא לא תאריך.' : 'A release is not a date.'}</p>
              <h3 className="mt-3 whitespace-nowrap text-[clamp(4.1rem,16vw,8.5rem)] font-medium leading-[.78] tracking-[-.08em] text-white" dir="ltr">Ensemblis</h3>
            </div>
      ...
      <ProjectLink project={project} locale={locale}>
        <div className="grid lg:grid-cols-[.7fr_1.3fr]">
          <div className="flex flex-col p-7 sm:p-10 lg:p-12">
            ...
            <h3 className="mt-12 whitespace-nowrap text-[clamp(3rem,12vw,5.6rem)] font-medium leading-[.84] tracking-[-.07em] text-[#2b1b16]" dir="ltr">WakeMyWay</h3>
      ...
      <ProjectLink project={project} locale={locale}>
        <div className="p-7 sm:p-10 lg:p-12">
          ...
          <div className="mt-9 grid gap-8 lg:grid-cols-[1fr_.55fr] lg:items-end">
            <h3 className="whitespace-nowrap text-[clamp(2.55rem,10vw,6.5rem)] font-medium leading-[.84] tracking-[-.07em] text-[#1d1d1f]" dir="ltr">CartShift Studio</h3>
    ...
    <main className="overflow-x-clip bg-[#eceae5] text-[#1d1d1f] selection:bg-[#6257d8] selection:text-white" dir={isHebrew ? 'rtl' : 'ltr'}>
      ...
      <section id="top" className="relative min-h-[100svh] overflow-hidden bg-[#171719] px-5 pb-6 pt-24 text-white sm:px-8 sm:pb-8 sm:pt-28 lg:px-12 lg:pb-10">
        ...
        <div className="relative mx-auto flex min-h-[calc(100svh-7rem)] max-w-[1680px] flex-col">
          ...
          <div className="mt-auto max-w-[1220px] pb-10 pt-20 sm:pb-14 lg:pb-16">
            ...
            <motion.h1 initial={reduceMotion ? false : { opacity: 0, y: 46 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.86, ease }} className="max-w-[13ch] text-balance text-[clamp(3.35rem,13vw,7.8rem)] font-medium leading-[0.84] tracking-[-0.07em] text-white">{copy.headline}</motion.h1>
      ...
      <section id="work" className="px-5 py-24 sm:px-8 sm:py-32 lg:px-12 lg:py-36">
        <div className="mx-auto max-w-[1680px]">
          <motion.div {...sectionReveal} className="mb-16 grid gap-8 lg:grid-cols-[0.22fr_0.78fr] lg:gap-12 sm:mb-24"><p className="text-[9px] font-semibold uppercase tracking-[0.18em] text-black/52 sm:text-[10px]">01 / {copy.workEyebrow}</p><div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between"><h2 className="max-w-[14ch] text-balance text-[clamp(3rem,11.5vw,6.1rem)] font-medium leading-[0.86] tracking-[-0.065em] text-[#1d1d1f]">{copy.workTitle}</h2><p className="max-w-md text-[13px] leading-6 text-black/62 sm:text-sm sm:leading-6 lg:pb-2">{copy.workIntro}</p></div></motion.div>
