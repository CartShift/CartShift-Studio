...
const selectedProjectOrder = ['cartshift', 'starlinker', 'rightflow', 'wakemyway'];
...
export default function YotamProfile() {
  ...
  const copy = isHebrew
    ? {
        ...
        download: 'הורדת CV',
        scroll: 'לניסיון',
        kicker: "יותם פרג'י · Senior Full-Stack & Product Engineer · ברלין",
        ...
        proofCuralifeLabel: 'אחריות מוצר ופלטפורמה ב-Curalife',
        proofSync: '85%-',
    ...
    : {
        ...
        scroll: 'Experience',
        kicker: 'Yotam Faraggi · Senior Full-Stack & Product Engineer · Berlin',
        ...
        proofCuralife: '4+ yrs',
        proofCuralifeLabel: 'product & platform ownership at Curalife',
        proofSync: '−85%',
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-[100svh] overflow-hidden bg-[#171719] px-5 pb-6 pt-24 text-white sm:px-8 sm:pb-8 sm:pt-28 lg:px-12 lg:pb-10">
        ...
        <div className="relative mx-auto flex min-h-[calc(100svh-7rem)] max-w-[1680px] flex-col">
          <div className="flex items-start justify-between text-[8px] font-semibold uppercase tracking-[0.17em] text-white/62 sm:text-[10px]">
            ...
            <span className="max-w-[14rem] text-end leading-4 sm:max-w-none sm:leading-5">
              {copy.availability}
              <br />
              Full-stack · Product · AI · Commerce
            </span>
          </div>
          ...
          <div className="mt-auto max-w-[1180px] pb-8 pt-20 sm:pb-12 lg:pb-14">
            <motion.p
              ...
              className="mb-5 text-[9px] font-semibold uppercase tracking-[0.18em] text-white/60 sm:text-[10px]"
            >
              {copy.kicker}
            </motion.p>
            <motion.h1
            ...
            >
              <a
                href="#work"
                className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-3 text-[9px] font-semibold uppercase tracking-[0.14em] text-[#1d1d1f] transition-transform hover:-translate-y-0.5"
              >
                {copy.work} <ArrowDown className="size-3.5" />
              </a>
              <a
                href={pdfHref}
                className="inline-flex items-center gap-2 rounded-full border border-white/30 px-5 py-3 text-[9px] font-semibold uppercase tracking-[0.14em] text-white transition-colors hover:bg-white/10"
              >
          ...
          <div className="grid gap-px border-t border-white/15 bg-white/15 sm:grid-cols-4">
            {proof.map(([value, label]) => (
              <div
                key={label}
                className="bg-[#171719]/88 px-0 py-4 sm:px-5 sm:py-5 first:sm:ps-0"
              >
                <p className="text-2xl font-medium tracking-[-0.05em] sm:text-3xl">{value}</p>
                <p className="mt-1 text-[8px] font-semibold uppercase tracking-[0.14em] text-white/52 sm:text-[9px]">
                  {label}
                </p>
              </div>
            ))}
          ...
          <a
            href="#profile"
            className="mt-4 flex items-center justify-end gap-2 text-[8px] font-semibold uppercase tracking-[0.17em] text-white/70 sm:text-[9px]"
          >
      ...
      <section id="profile" className="px-5 py-24 sm:px-8 sm:py-32 lg:px-12 lg:py-36">
        ...
        >
          <p className="text-[9px] font-semibold uppercase tracking-[0.18em] text-black/55 sm:text-[10px]">
            01 / {copy.profile}
          </p>
          <div>
            ...
            <div className="mt-10 grid gap-8 border-t border-black/20 pt-7 sm:grid-cols-2 lg:mt-14">
              ...
              <div className="grid content-start border-t border-black/20 sm:border-t-0">
                {profileMeta.map(([label, value]) => (
                  <div
                    key={label}
                    className="grid grid-cols-[0.38fr_0.62fr] gap-4 border-b border-black/20 py-4 text-[11px] leading-5 sm:text-xs"
                  >
                    <span className="font-semibold uppercase tracking-[0.12em] text-black/50">
                      {label}
                    </span>
                    <span
                      className="text-black/72"
                      dir={label === copy.emailLabel || label === copy.phoneLabel ? 'ltr' : undefined}
                    >
                      {value}
                    </span>
                  </div>
        ...
        <div className="mx-auto max-w-[1680px]">
            ...
            {cv.recentExperiences.map((item, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-2 text-[10px] font-semibold uppercase leading-5 tracking-[0.13em] text-white/58">
                    {item.title}
                  </p>
                  {item.location ? (
                    <p className="mt-1 text-[11px] text-white/48">{item.location}</p>
                  ) : null}
                </div>
                <div>
                  {item.description ? (
          ...
          <div className="mt-14 grid gap-8 sm:mt-20 lg:grid-cols-[0.22fr_0.78fr] lg:gap-12">
            <div>
              ...
              <p className="mt-3 max-w-[15rem] text-[12px] leading-5 text-white/48">
                {copy.earlierIntro}
              </p>
            </div>
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden border-b border-black/12 bg-[#dedbd4]">
                  {project.hero ? (
                    ...
                    <div className="flex h-full items-center justify-center text-[10px] font-semibold uppercase tracking-[0.16em] text-black/38">
                      {project.descriptor}
                    </div>
                  )}
                  <div className="absolute inset-x-4 top-4 flex items-center justify-between text-[8px] font-semibold uppercase tracking-[0.14em] text-black/48 sm:inset-x-5 sm:top-5">
                ...
                <div className="p-6 sm:p-7">
                  <div className="flex items-start justify-between gap-6">
                    <div>
                      <p className="text-[8px] font-semibold uppercase tracking-[0.14em] text-black/45">
                        {project.descriptor}
                      </p>
                      <h3
                  ...
                  <div className="mt-6 border-t border-black/14 pt-5">
                    <p className="text-[8px] font-semibold uppercase tracking-[0.14em] text-black/42">
                      {copy.roleLabel}
                    </p>
                    <p className="mt-2 text-[12px] leading-5 text-black/64">{project.role}</p>
                    <div className="mt-4 flex flex-wrap gap-2">
                      {project.technologies.slice(0, 5).map(technology => (
                        <span
                          key={technology}
                          className="border border-black/13 px-2.5 py-1.5 text-[8px] font-semibold uppercase tracking-[0.1em] text-black/48"
                        >
                          {technology}
                        </span>
                      ))}
                  ...
                  <div className="mt-6 flex items-center justify-end gap-2 text-[9px] font-semibold uppercase tracking-[0.13em] text-black/55">
        ...
        <div className="mx-auto max-w-[1680px]">
          ...
          <div className="border-t border-black/20 lg:ms-[22%]">
            {cv.skills.map((skill, index) => (
              ...
              >
                <p className="text-[9px] font-semibold uppercase tracking-[0.17em] text-black/45">
        ...
        <div className="mx-auto grid max-w-[1680px] gap-10 lg:grid-cols-[0.22fr_0.78fr] lg:gap-12">
          ...
          <div>
            ...
            <div className="mt-12 grid gap-12 border-t border-black/20 pt-8 lg:grid-cols-2">
              <div>
                <p className="mb-5 text-[9px] font-semibold uppercase tracking-[0.17em] text-black/50">
                ...
                {cv.education.map(item => (
                  ...
                  >
                    ...
                    {item.years ? (
                      <p className="mt-2 text-[9px] font-semibold uppercase tracking-[0.13em] text-black/48">
                        {item.years}
                      </p>
                    ) : null}
                  </div>
