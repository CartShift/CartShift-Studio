...
export default async function ShopifyPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const faqSchema = generateFAQPageSchema([
    ...
    },
    {
      ...
      answer:
        " started is easy! Simply contact us through our contact form or schedule a free consultation. We'll discuss your project requirements, answer any questions, and provide a detailed proposal. There's no obligation, and we're here to help you succeed.",
    },
  ]);
