      ...
      >
            ...
            <div className="relative flex flex-col lg:flex-row items-center gap-6 lg:gap-16">
              ...
              <div className="flex-1 text-center lg:text-start">
                ...
                >
                  ...
                  <a href="mailto:yotamon@gmail.com" className="flex items-center gap-1.5 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white">{t('sections.summary')}</h2>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6 lg:mb-8">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white">{t('sections.experience')}</h2>
            </div>
          </div>

          <div className="relative">
            {/* Timeline line with gradient - Visible on mobile now */}
            <div className={`absolute ${isRTL ? 'right-4 lg:right-8' : 'left-4 lg:left-8'} top-0 bottom-0 w-0.5 block`}>
              ...
              {experienceKeys.map((expKey, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`absolute top-8 ${isRTL ? 'right-4 w-4 lg:right-7 lg:w-8' : 'left-4 w-4 lg:left-7 lg:w-8'} h-[2px] bg-gradient-to-r from-slate-200 to-transparent dark:from-white/10 dark:to-transparent block`} />

                    {/* Timeline dot - Responsive positioning */}
                    <div className={`absolute ${isRTL ? 'right-[calc(1rem+1px)] lg:right-[calc(2rem+1px)] translate-x-1/2' : 'left-[calc(1rem+1px)] lg:left-[calc(2rem+1px)] -translate-x-1/2'} top-[1.7rem] ${isSelfEmployment ? 'w-2.5 h-2.5' : 'w-3 h-3'} block z-20`}>
                      <div className={`absolute inset-0 ${isSelfEmployment ? 'bg-slate-300 dark:bg-surface-600' : 'bg-primary-500 dark:bg-primary-400'} rounded-full ${isSelfEmployment ? '' : 'animate-ping opacity-20'}`} />
                      <div className={`absolute inset-0 ${isSelfEmployment ? 'bg-slate-300 dark:bg-surface-600' : 'bg-gradient-to-br from-primary-500 to-accent-600'} rounded-full shadow-sm ring-2 ring-slate-50 dark:ring-[#0a0a0f]`} />
                    </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white">{t('sections.skills')}</h2>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white">{t('sections.education')}</h2>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative backdrop-blur-xl bg-white/60 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.06] rounded-xl p-3 sm:p-5 shadow-sm dark:shadow-none">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-1">{t('education.university')}</h3>
                    <p className="text-primary-600 dark:text-primary-400 text-sm font-medium mb-1">
                      {t('education.program')}
                    </p>
                    <p className="text-slate-500 dark:text-surface-500 text-xs mb-2">{t('education.years')}</p>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white">{t('sections.languages')}</h2>
            </div>
