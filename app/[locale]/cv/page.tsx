...
const skillCategories: SkillCategory[] = [
  ...
  { key: 'backend', icon: Zap, gradient: 'from-violet-400 via-purple-500 to-fuchsia-600', bgGlow: 'violet' },
  { key: 'cloud', icon: Globe, gradient: 'from-emerald-400 via-teal-500 to-cyan-600', bgGlow: 'emerald' },
  { key: 'ecommerce', icon: TrendingUp, gradient: 'from-amber-400 via-orange-500 to-red-600', bgGlow: 'amber' },
  { key: 'database', icon: Target, gradient: 'from-pink-400 via-rose-500 to-red-600', bgGlow: 'pink' },
  { key: 'apis', icon: Sparkles, gradient: 'from-indigo-400 via-blue-500 to-cyan-600', bgGlow: 'indigo' },
];

const experienceKeys = ['cartshift', 'curalife', 'paragonex', 'ecommerce_venture', 'hot', 'leumi', 'entrepreneurship', 'elbit', 'airforce'];
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-accent-900/20 via-transparent to-transparent" />

        {/* Animated gradient orbs */}
        <GradientOrb
          className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-gradient-to-br from-primary-500/20 to-cyan-500/10 rounded-full blur-[100px]"
          delay={0}
        />
        <GradientOrb
          className="absolute top-1/3 -left-40 w-[500px] h-[500px] bg-gradient-to-br from-accent-500/20 to-pink-500/10 rounded-full blur-[100px]"
          delay={2}
        />
        <GradientOrb
          className="absolute -bottom-40 right-1/4 w-[400px] h-[400px] bg-gradient-to-br from-violet-500/15 to-indigo-500/10 rounded-full blur-[100px]"
          delay={4}
        />
      ...
      >
        ...
        >
          {/* Elegant card */}
          <div className="relative backdrop-blur-xl bg-gradient-to-br from-white/[0.04] to-white/[0.01] border border-white/[0.06] rounded-2xl lg:rounded-3xl p-5 sm:p-6 lg:p-12 overflow-hidden">
            ...
            <div className="relative flex flex-col lg:flex-row items-center gap-6 lg:gap-16">
              ...
              >
                ...
                <div className="relative w-28 h-28 sm:w-36 sm:h-36 lg:w-44 lg:h-44 rounded-2xl overflow-hidden ring-1 ring-white/10">
                  <Image
                ...
                <div className="absolute -bottom-1 -right-1 flex items-center gap-1.5 px-2.5 py-1 bg-emerald-500/90 rounded-full">
                  <span className="relative flex h-1.5 w-1.5">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-white opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-white"></span>
                  </span>
                  <span className="text-[10px] font-medium text-white uppercase tracking-wide">Open to work</span>
                </div>
              </motion.div>
              ...
              <div className="flex-1 text-center lg:text-start">
                <motion.h1
                  ...
                  className="text-3xl sm:text-4xl lg:text-6xl font-bold mb-2 lg:mb-3 tracking-tight text-white"
                >
                  {t('name')}
                </motion.h1>
                ...
                <motion.p
                  ...
                  className="text-base sm:text-lg lg:text-xl text-surface-300 font-light mb-4 lg:mb-6 max-w-xl"
                >
                  {t('subtitle')}
                </motion.p>
                ...
                <motion.div
                  ...
                  className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start items-center gap-x-4 gap-y-2 text-xs sm:text-sm text-surface-400"
                >
                  <a href="https://maps.google.com/?q=Berlin,Germany" target="_blank" rel="noopener noreferrer"
                  ...
                  <a href="mailto:yotamon@gmail.com" className="flex items-center gap-1.5 hover:text-primary-400 transition-colors">
                    <Mail className="w-3.5 h-3.5" />
                    <span>{t('email')}</span>
                  </a>
                  <span className="hidden sm:inline text-surface-600">•</span>
                  <a href="https://linkedin.com/in/yotam-faraggi" target="_blank" rel="noopener noreferrer"
                     className="flex items-center gap-1.5 hover:text-primary-400 transition-colors">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">{t('sections.summary')}</h2>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative backdrop-blur-xl bg-white/[0.02] border border-white/[0.06] rounded-xl p-5 sm:p-6 lg:p-8">
              <p className="text-sm sm:text-base lg:text-lg text-surface-300 leading-relaxed">
                {t('summary.text')}
              </p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6 lg:mb-8">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">{t('sections.experience')}</h2>
            </div>
          </div>

          <div className="relative">
            {/* Timeline line with gradient */}
            <div className={`absolute ${isRTL ? 'right-6 lg:right-8' : 'left-6 lg:left-8'} top-0 bottom-0 w-0.5 hidden lg:block`}>
              <div className="absolute inset-0 bg-gradient-to-b from-primary-500 via-accent-500 to-surface-700" />
            ...
            <div className="space-y-4 sm:space-y-6">
              {experienceKeys.map((expKey, index) => {
                ...
                return (
                  ...
                  >
                    {/* Timeline dot - smaller and muted for self-employment */}
                    <div className={`absolute ${isRTL ? 'right-4 lg:right-6' : 'left-4 lg:left-6'} top-10 ${isSelfEmployment ? 'w-3 h-3' : 'w-4 h-4'} hidden lg:block`}>
                      <div className={`absolute inset-0 ${isSelfEmployment ? 'bg-surface-600' : 'bg-gradient-to-br from-primary-400 to-accent-500'} rounded-full ${isSelfEmployment ? '' : 'animate-pulse'}`} />
                      <div className="absolute inset-1 bg-[#0a0a0f] rounded-full" />
                      <div className={`absolute inset-2 ${isSelfEmployment ? 'bg-surface-500' : 'bg-gradient-to-br from-primary-400 to-accent-500'} rounded-full`} />
                    </div>

                    <div className={`${isRTL ? 'lg:mr-20' : 'lg:ml-20'} relative`}>
                      {!isSelfEmployment && (
                      ...
                      <div className={`relative backdrop-blur-xl border rounded-xl transition-all duration-300 ${
                        isSelfEmployment
                          ? 'bg-white/[0.01] border-white/[0.04] hover:border-white/[0.08] p-3 sm:p-4'
                          : 'bg-white/[0.02] border-white/[0.06] hover:border-primary-500/20 p-4 sm:p-5 lg:p-6 hover:bg-white/[0.04]'
                      }`}>
                        {/* Company header with Open for Work badge */}
                        <div className={`flex flex-col lg:flex-row lg:items-start lg:justify-between gap-3 ${isSelfEmployment && highlights.length === 0 ? '' : 'mb-4'}`}>
                          <div>
                            <div className="flex items-center gap-2 flex-wrap mb-1">
                              <h3 className={`${isSelfEmployment ? 'text-base sm:text-lg font-semibold text-surface-300' : 'text-lg sm:text-xl font-bold text-white'}`}>
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                              <span className={`${isSelfEmployment ? 'text-sm text-surface-400' : 'text-sm sm:text-base font-semibold bg-gradient-to-r from-primary-400 to-accent-400 bg-clip-text text-transparent'}`}>
                        ...
                        {hasDescription && !isSelfEmployment && (
                          <p className="text-surface-300/80 mb-4 text-sm sm:text-base leading-relaxed">
                        ...
                        {highlights.length > 0 && (
                          <ul className="space-y-2">
                            {highlights.map((highlight, hIndex) => (
                              <li
                                key={hIndex}
                                className="flex items-start gap-2 text-surface-300/90 text-xs sm:text-sm"
                              >
                                <span className={`mt-0.5 flex-shrink-0 ${isRTL ? 'rotate-180' : ''}`}>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">{t('sections.skills')}</h2>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {skillCategories.map((skill, index) => {
              ...
              return (
                ...
                >
                  <div className={`absolute -inset-0.5 bg-gradient-to-r ${skill.gradient} rounded-xl blur opacity-0 group-hover:opacity-30 transition-all duration-500`} />

                  <div className="relative h-full backdrop-blur-xl bg-white/[0.02] border border-white/[0.06] group-hover:border-white/[0.12] rounded-xl p-4 sm:p-5 transition-all duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">{t('sections.education')}</h2>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative backdrop-blur-xl bg-white/[0.02] border border-white/[0.06] rounded-xl p-4 sm:p-5">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-bold text-white mb-1">{t('education.university')}</h3>
                    <p className="text-primary-400 text-sm font-medium mb-1">
                      {t('education.program')}
                    </p>
                    <p className="text-surface-500 text-xs mb-2">{t('education.years')}</p>
                    <p className="text-surface-300/80 text-xs sm:text-sm leading-relaxed">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">{t('sections.languages')}</h2>
            </div>
